...
public class MongoGrades {
    ...
    public void addGrade(){
        ...
        gradeOne.setStudent(mongoBase.studentsList("Filip","Wojciechowski").get(0));
        gradeTwo.setDate(new Date());
        gradeTwo.setGradeValue(3.5);
        gradeTwo.setStudent(mongoBase.studentsList("Filip","Wojciechowski").get(0));
        gradeThree.setDate(new Date());
        gradeThree.setGradeValue(4.0);
        gradeThree.setStudent(mongoBase.studentsList("Nowy","Pawlak").get(1));
        gradeFour.setDate(new Date());
        gradeFour.setGradeValue(4.5);
        gradeFour.setStudent(mongoBase.studentsList("Filip","Wojciechowski").get(1));
        gradeFive.setDate(new Date());
        gradeFive.setGradeValue(5.0);
        gradeFive.setStudent(mongoBase.studentsList("Nowy","Pawlak").get(2));
